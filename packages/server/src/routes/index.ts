...
// tyler-ext routes
import tylerExtRouter from './tyler-ext'

import authRouter from '../enterprise/routes/auth'
import workspaceRouter from '../enterprise/routes/workspace'
import auditRouter from '../enterprise/routes/audit'
import organizationRouter from '../enterprise/routes/organization'
import ssoRouter from '../enterprise/routes/sso'
...
// tyler-ext endpoints
router.use('/tylerExt', tylerExtRouter)
