export class Permissions {
    ...
    constructor() {
        // TODO: To be implemented with Organization Member Role
        ...
        // auditCategory.addPermission(new Permission('loginActivity:view', 'View Login Activity'))
        // auditCategory.addPermission(new Permission('loginActivity:delete', 'Delete Login Activity'))
        ...
        // workspaceCategory.addPermission(new Permission('workspace:add-user', 'Assign User'))
        ...
        workspaceCategory.addPermission(new Permission('workspace:export', 'Export'))
        workspaceCategory.addPermission(new Permission('workspace:import', 'Import'))
        this.categories.push(workspaceCategory)

        const logsCategory = new PermissionCategory('logs')
        logsCategory.addPermission(new Permission('logs:view', 'View Logs'))
