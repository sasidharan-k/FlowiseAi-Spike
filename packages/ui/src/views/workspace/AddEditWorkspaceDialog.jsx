...
const AddEditWorkspaceDialog = ({ show, dialogProps, onCancel, onConfirm }) => {
    ...
    const addNewWorkspace = async () => {
        try {
            ...
            if (createResp.data) {
                if (createResp.data instanceof Array) {
                    store.dispatch(workspacesUpdated(createResp.data))
                }
                enqueueSnackbar({
    ...
    const saveWorkspace = async () => {
        try {
            ...
            const saveResp = await workspaceApi.updateWorkspace(workspace.id, saveObj)
            if (saveResp.data) {
                if (saveResp.data instanceof Array) {
                    store.dispatch(workspacesUpdated(saveResp.data))
                }
                enqueueSnackbar({
