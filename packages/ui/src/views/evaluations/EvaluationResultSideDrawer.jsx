                        ...
                        <Card key={indexedDB} sx={{ mt: 2, border: '1px solid #e0e0e0', borderRadius: `15px` }}>
                            <CardContent>
                                ...
                                <Box>
                                    ...
                                    <Typography variant='body2'>{dialogProps.data.actualOutput[index]}</Typography>
                                </Box>
                                <br />
                                <Divider />
                                <Box>
                                            ...
                                            <Chip
                                                ...
                                                label={
                                                    dialogProps.data.metrics[index]?.totalTokens
                                                        ? 'Total: ' + dialogProps.data.metrics[0]?.totalTokens
                                                        : 'Total: N/A'
                                                }
                                            />
                                            <Chip
                                            ...
                                            <Chip
                                                ...
                                                label={
                                                    dialogProps.data.metrics[index]?.totalCost
                                                        ? 'Total: ' + dialogProps.data.metrics[0]?.totalCost
                                                        : 'Total: N/A'
                                                }
                                            />
                                            <Chip
                                ...
                                <Divider />
                                <br />
                                {dialogProps.data.customEvals[index] && dialogProps.data.customEvals[index].length > 0 && (
                                    <Box>
                                        <Typography variant='overline' style={{ fontWeight: 'bold' }}>
                                            Custom Evaluators
                                        </Typography>
                                                    ...
                                                    >
                                                        ...
                                                        <Chip
                                                            ...
                                                            label={`${
                                                                ...
                                                                ?.label.toLowerCase()} ${
                                                                evaluator.type === 'text' ? '"' + evaluator.value + '"' : evaluator.value
                                                            }`}
                                                        ></Chip>
                                                    </Stack>
                                                ))}
