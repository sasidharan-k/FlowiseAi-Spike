...
const NavGroup = ({ item }) => {
    ...
    const shouldDisplayMenu = (menu) => {
        ...
        if (menu.display) {
            if (isCloud && menu.display.includes('cloud')) return true
            if (isEnterpriseLicensed && menu.display.includes('enterprise')) return true
            return false // If no match, do not display
        }
